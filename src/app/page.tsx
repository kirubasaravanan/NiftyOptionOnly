...
import { Activity, BarChart3, BookOpen, Settings, TrendingUp } from "lucide-react";
...
type Tab = "dashboard" | "backtest" | "journal" | "config";
      ...
      <div className="min-h-screen bg-background">
        ...
        <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
          <div className="container mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Badge variant="outline" className="text-[10px]">v0.2.0</Badge>
            </div>
          </div>
        ...
        <footer className="border-t mt-auto bg-muted/30">
          <div className="container mx-auto px-4 py-4 text-xs text-muted-foreground flex flex-col md:flex-row md:items-center md:justify-between gap-2">
            <div>
              Phase 1-6: data · features · regime · Long CE/PE + NO-TRADE · paper · backtest
            </div>
            <div className="flex items-center gap-3">
              <span>
                <Badge variant="outline" className="text-[10px]">DhanHQ adapter</Badge>
              </span>
              <span>
                <Badge variant="outline" className="text-[10px]">Real data only — no synthetic</Badge>
              </span>
              <span>
                <Badge variant="outline" className="text-[10px]">NO-TRADE is a valid strategy</Badge>
              </span>
            </div>
          </div>
        </footer>
